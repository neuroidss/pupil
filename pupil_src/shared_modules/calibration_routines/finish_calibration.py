...
from optimization_calibration import point_line_calibration , line_line_calibration , five_point_algo_calibration
...
#             success, orientation, translation  = five_poin_calibration(sphere_pos, ref_3d,  gaze_direction_3d, initial_orientation, initial_translation)
...
def finish_calibration_rays(g_pool,pupil_list,ref_list):
    ...
    if mode == '3d':
        if matched_binocular_data:
            ...
            ##success, orientation, translation  = five_point_algo_calibration(sphere_pos, ref_3d,  gaze_direction_3d, initial_orientation, initial_translation, fix_translation = True)
            success, orientation, translation  = five_point_algo_calibration(sphere_pos, ref_3d,  gaze_direction_3d, initial_orientation, initial_translation, fix_translation = True)
